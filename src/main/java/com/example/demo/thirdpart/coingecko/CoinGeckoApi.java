package com.example.demo.thirdpart.coingecko;

import com.example.demo.thirdpart.coingecko.exception.CoinGeckoApiException;
...
public class CoinGeckoApi {
    private final String API_BASE_URL = "http://api.coingecko.com/api/v3/";
